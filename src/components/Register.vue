    ...
    <div class="form_sing">
      ...
      <form class="registration" @submit.prevent="onSignup">
        <div class="form-group">
          <label for="login" class="col-form-label marg10">Имя</label>
          <div>
            <input type="text" class="form-control" placeholder="Иван" v-model="user.name">
          </div>
        </div>
        <div class="form-group">
          <label for="login" class="col-form-label marg10">Электронная почта</label>
          <div>
            <input
              type="text"
              class="form-control"
        ...
        <div class="form-group">
          <label for="password" class="col-sm-2 col-form-label marg10">Подтверждение пароля</label>
          <div>
            <input
              type="password"
              class="form-control"
        ...
        <div class="but_reg">
          <button href="#" type="submit" class="btn button_sl1">Регистрация</button>
        </div>
      </form>
      <div class="icons_reg">
